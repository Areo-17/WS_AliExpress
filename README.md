...
First of all, create the folder in which you will be working the project, you have to create this from the file explorer. After this, open Visual Studio Code and choose the created folder.
